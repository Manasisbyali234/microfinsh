      ...
      <div ref={ref} className="footer-main container">
        ...
        <div className={`footer-brand anim fade-up ${inView ? 'in-view' : ''}`}>
          ...
          <div className="footer-socials">
            ...
            <a href="https://wa.me/919900431038" target="_blank" rel="noreferrer" aria-label="WhatsApp" className="footer-social-icon">
            ...
            <a href="https://twitter.com" target="_blank" rel="noreferrer" aria-label="Twitter / X" className="footer-social-icon">
