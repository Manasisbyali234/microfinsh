...
const MILESTONES = [
  { year: '1971', text: 'Founded as a precision valve manufacturer serving the Indian oil & gas sector.' },
...
const TAB_CONTENT = {
  ...
  'Commitment to Quality': 'Every product is manufactured under our ISO 9001 quality management system. Our in-house testing facilities include hydrostatic, pneumatic, and fugitive emission testing to API, ASME, and BS standards.',
    ...
    <main>
      ...
      <section className="page-header blueprint-bg about-header">
        <div className="about-header-img-wrap">
          <img
            src="https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=1600&q=85"
        ...
        <div ref={timelineRef} className="container about-history-grid">
          ...
          <div className="about-img-stack">
            <div className={`about-img-main-wrap anim fade-right ${timelineIn ? 'in-view' : ''}`}>
              <img
                src="https://images.unsplash.com/photo-1581092160562-40aa08e78837?w=700&q=85"
                alt="Valve manufacturing floor"
            ...
            <div className={`about-img-tertiary-wrap anim fade-right delay-3 ${timelineIn ? 'in-view' : ''}`}>
              <img
                src="https://images.unsplash.com/photo-1518770660439-4636190af475?w=700&q=85"
                alt="Industrial control systems"
                className="about-img-tertiary"
              />
            </div>
          </div>
        </div>
